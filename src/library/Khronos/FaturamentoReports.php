...
class Khronos_FaturamentoReports {
	public static $xmlGrupos = '/../tomcat/Reports/report/grupos-faturamento.xml';
	public static $xmlRelatorios = '/../tomcat/Reports/report/xml-faturamento/';
	public static function getJsonTreeList () {
		$lang = DMG_Translate::getLang();
		$a = realpath(APPLICATION_PATH . Khronos_FaturamentoReports::$xmlGrupos);
		$b = realpath(APPLICATION_PATH . Khronos_FaturamentoReports::$xmlRelatorios) . DIRECTORY_SEPARATOR . '*.xml';
		$json = array();
		if ($a && $b) {
	...
	public static function getFilterList ($reportID) {
		$lang = DMG_Translate::getLang();
		$b = glob(realpath(APPLICATION_PATH . Khronos_FaturamentoReports::$xmlRelatorios) . DIRECTORY_SEPARATOR . '*.xml');
		foreach ($b as $k) {
