...
class ParceiroController extends Zend_Controller_Action {
	...
	public function listAction () {
		if (DMG_Acl::canAccess(50) || DMG_Acl::canAccess(26) || DMG_Acl::canAccess(27)) {
			...
			if($this->getRequest()->getParam('combo') == "true"){
				array_unshift($data, array('id'=>"", "nm_parceiro"=>"", "nm_empresa"=>""));
			}
