 ...
 * @property ScmStatusFechamentoDoc $ScmStatusFechamentoDoc
 ...
 */
abstract class BaseScmFechamentoDoc extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('scm_fechamento_doc');
        ...
        $this->hasColumn('dt_fechamento', 'timestamp', 25, array(
             'type' => 'timestamp',
             'primary' => false,
             'notnull' => true,
             'autoincrement' => false,
        ...
        $this->hasColumn('id_status_fechamento_doc', 'integer', 4, array(
             'type' => 'integer',
             'unsigned' => 0,
             'primary' => false,
             'notnull' => true,
    ...
    $this->hasOne('ScmUser', array(
        ...
        $this->hasOne('ScmStatusFechamentoDoc', array(
             'local' => 'id_status_fechamento_doc',
             'foreign' => 'id'));

        $this->hasMany('ScmFechamentoItem', array(
             'local' => 'id',
             'foreign' => 'id_fechamento_doc'));
    }
}