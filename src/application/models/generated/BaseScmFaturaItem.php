 ...
 * @property integer $dias_na_fatura
 * @property integer $percent_local
 * @property decimal $vl_bruto
 * @property decimal $vl_local
 * @property decimal $vl_empresa
...
abstract class BaseScmFaturaItem extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('nr_credito', 'integer', 4, array(
             'type' => 'integer',
             'notnull' => true,
             'length' => '4',
             ));
        ...
        $this->hasColumn('dias_na_fatura', 'integer', null, array(
             'type' => 'integer',
             ));
        ...
        $this->hasColumn('vl_bruto', 'decimal', 10, array(
             'type' => 'decimal',
             'notnull' => true,
             'length' => '10',
             ));
        $this->hasColumn('vl_local', 'decimal', 10, array(
             'type' => 'decimal',
             'notnull' => true,
             'length' => '10',
             ));
        $this->hasColumn('vl_empresa', 'decimal', 10, array(
             'type' => 'decimal',
             'notnull' => true,
             'length' => '10',
             ));
