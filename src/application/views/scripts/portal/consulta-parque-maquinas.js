...
var AdministrationGroupWindowFilter = new Ext.ux.grid.GridFilters({
	local: false,
	menuFilterText: 'Portal.Names.br.grid_filter_label',
	filters: [{
		type: 'string',
		dataIndex: 'name',
		phpMode: true
...
*/
var ConsultaParqueMaquinasPortalWindow = Ext.extend(Ext.grid.GridPanel, {
	border: false,
	stripeRows: true,
	loadMask: true,
	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			<?php endif; ?>
			columns: [Portal.ParqueMaquinas.sm, {
				dataIndex: 'id',
...
Ext.reg('consulta-parque-maquinas', ConsultaParqueMaquinasPortalWindow);