var RegularizacaoFormFalha = Ext.extend(Ext.Window, {
	maquina: 0,
	modal: true,
	constrain: true,
	maximizable: false,
	...
	width: 378,
	height: 310,
	title: '<?php echo DMG_Translate::_('regularizacao.falha.title'); ?>',
	layout: 'fit',
	closeAction: 'hide',
	...
	constructor: function() {
		...
		RegularizacaoFormFalha.superclass.constructor.apply(this, arguments);
	},
	initComponent: function() {
		...
		this.formPanel = new Ext.FormPanel({
			...
			{fieldLabel: '<?php echo DMG_Translate::_('regularizacao.motivo.text'); ?>', name: 'motivo', allowBlank: false, maxLength: 255, width: 200, xtype: 'textfield'},
		...
		RegularizacaoFormFalha.superclass.initComponent.call(this);
	},
	show: function() {
		...
		RegularizacaoFormFalha.superclass.show.apply(this, arguments);
	},
	_onFormLoad: function () {
		this.el.unmask();
	},
	onDestroy: function() {
		RegularizacaoFormFalha.superclass.onDestroy.apply(this, arguments);
		this.formPanel = null;
	},
	_onBtnSalvarClick: function() {
		...
		uiHelper.confirm('<?php echo DMG_Translate::_('grid.form.confirm.title'); ?>', '<?php echo DMG_Translate::_('regularizacao.confirmar'); ?>', function (o) {
			...
			form.submit({
				url: '<?php echo $this->url(array('controller' => 'regularizacao', 'action' => 'save-falha'), null, true); ?>',
				params: {
					id: this.maquina,
				},
				scope:this,
